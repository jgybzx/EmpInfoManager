...
<div class="container">
    ...
    <form action="EmpServlet">
        <input name="action" value="deleteMultiple" hidden>
        <table border="1" class="table table-bordered table-hover">
            ...
            <tr>
                <td colspan="9" align="center">
                    <a class="btn btn-primary" href="add.jsp?pageNumber=${pageBeans.pagNumber}">添加员工</a>
                    <input id ="deleteBtn" class="btn btn-primary" type="button" value="删除选中"
            ...
            <script>
                function deleteMultiple() {
                    var flag = confirm("是否删除");//点了是就返回 true
                    if (flag) {
                        document.querySelector("#deleteBtn").setAttribute("type","submit");
                        return ture;
                    }else {
                        return  false;
                    }
                        ...
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageBeans.totalPage}" step="1" varStatus="index">
                                <li class="${pageBeans.pagNumber==index.count?'active':''}"><a
                                        href="${pageContext.request.contextPath}/EmpServlet?action=findAll&pageNumber=${index.count}">${index.count}</a>
                                </li>
                            </c:forEach>
